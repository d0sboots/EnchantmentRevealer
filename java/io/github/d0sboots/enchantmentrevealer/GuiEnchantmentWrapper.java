...
public class GuiEnchantmentWrapper extends GuiEnchantment {
    ...
    private static final FieldHelper<IWorldNameable, GuiEnchantment> nameableField =
            FieldHelper.from(IWorldNameable.class, GuiEnchantment.class);
    ...
    private final IWorldNameable nameableShadow;
    ...
    public GuiEnchantmentWrapper(
            InventoryPlayer inventory, World worldIn, EnchantmentWorker worker, BlockPos pos, IWorldNameable nameable) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (isPointInRegion(TITLE_OFFSET_X, TITLE_OFFSET_Y, 160, 9, mouseX, mouseY)) {
            ...
            message = nameableShadow.getDisplayName().getUnformattedText();
